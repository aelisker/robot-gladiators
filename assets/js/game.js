...
var fight = function(enemyName) {
    ...
    while(enemyHealth > 0 && playerHealth > 0) {
        ...
        console.log(
            playerName + " attacked " + enemyName + " and did " + damage + " points of damage. " + enemyName + " now has " + enemyHealth + " health remaining."
            );
        ...
        console.log(
            enemyName + " attacked " + playerName + " and did " + damage + " points of damage. " + playerName + " now has " + playerHealth + " health remaining."
            );
        //check player health
        if (playerHealth <= 0) {
